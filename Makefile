...
GAMEPROJECTFILE =/mnt/crucial-ssd/UnrealGames/MarbleRun/MarbleRun.uproject
...
TARGETS = \
	...
	UE4Server \
	MarbleRun-Linux-Debug  \
	MarbleRun-Linux-DebugGame  \
	MarbleRun-Linux-Shipping  \
	MarbleRun-Linux-Test  \
	MarbleRun \
	MarbleRunEditor-Linux-Debug  \
	MarbleRunEditor-Linux-DebugGame  \
	MarbleRunEditor-Linux-Shipping  \
	MarbleRunEditor-Linux-Test  \
	MarbleRunEditor\
	configure
...
MarbleRun-Linux-Debug:
	 $(PROJECTBUILD) MarbleRun Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRun-Linux-DebugGame:
	 $(PROJECTBUILD) MarbleRun Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRun-Linux-Shipping:
	 $(PROJECTBUILD) MarbleRun Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRun-Linux-Test:
	 $(PROJECTBUILD) MarbleRun Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRun:
	 $(PROJECTBUILD) MarbleRun Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRunEditor-Linux-Debug:
	 $(PROJECTBUILD) MarbleRunEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRunEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MarbleRunEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRunEditor-Linux-Shipping:
	 $(PROJECTBUILD) MarbleRunEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRunEditor-Linux-Test:
	 $(PROJECTBUILD) MarbleRunEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MarbleRunEditor:
	 $(PROJECTBUILD) MarbleRunEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
